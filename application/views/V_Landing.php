...
<body class="landing-page sidebar-collapse">
  <nav class="navbar navbar-transparent navbar-color-on-scroll fixed-top navbar-expand-lg" color-on-scroll="100" id="sectionsNav">
    <div class="container">
      <div class="navbar-translate"><a class="navbar-brand" href="#">Aplikasi Antrian Rumah Sakit Sekabupaten Cirebon</a></div>
    ...
    <div class="container">
      <nav class="float-left">
        <ul>
          ...
          <li><a href="https://github.com/priscilya/Kelompok-5.git" target="_blank">Lisensi</a> </li>
        </ul>
      </nav>
      <div class="copyright float-right"> &copy;
        <script>
        document.write(new Date().getFullYear())
        </script>, dibuat dengan <i class="material-icons">tugas akhir</i> oleh <a href="https://tinylab.tk/about/" target="_blank">kelompok 5</a>. </div>
    </div>
  </footer>
