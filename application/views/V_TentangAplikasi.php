        ...
        <div class="row">
          <div class="col-md-6 ml-auto mr-auto">
            <div class="profile">
              ...
              <div class="name">
                <h3 class="title">Aplikasi Antrian Rumah Sakit Sekabupaten Cirebon</h3>
              <h6 style="margin-top:-20px;">versi tugas akhir</h6> </div>
            </div>
          </div>
        </div>
        <div class="description text-center" style="padding-bottom: 40px;">
          <p>ini adalah aplikasi pengambilan no antrian RS sekabupaten cirebon. aplikasi ini dibuat oleh kelompok 5</p>
