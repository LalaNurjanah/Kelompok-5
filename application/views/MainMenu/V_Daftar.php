...
<body class="landing-page sidebar-collapse">
  <nav class="navbar  fixed-top navbar-expand-lg bg-rose" id="sectionsNav">
    <div class="container">
      <div class="navbar-translate"> <a class="title">Aplikasi Antrian Rumah Sakit Sekabupaten Cirebon</a>
    ...
    <footer class="footer footer-default">
      <div class="container">
        ...
        <div class="copyright float-right">&copy;
          ...
          </script>, dibuat dengan <i class="material-icons">tugas akhir</i> oleh <a href="#" target="_blank">kelompok 5</a>.</div>
        </div>
      </footer>
